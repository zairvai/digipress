...
const PageTagAdd = props => {
    ...
    const links = [['Content',`/${auth.account.uniqueURL}/content/classrooms`,''],['Tags',`/${auth.account.uniqueURL}/content/tags`,''],['Add new tag',`/${auth.account.uniqueURL}/content/tags/add`,'active']]
