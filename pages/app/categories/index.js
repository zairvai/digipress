...
class index extends React.Component {
    ...
    pagename="Categories"
	links = [['App','/app/classrooms',''],['Categories','/app/categories','active']]
                            ...
                            <Col md={12}>
                                <div className="fright">
                                    <ul className="vurox-horizontal-links vurox-standard-ul pt-3">
                                        <li className="p-0"><Link href={{pathname:'/app/articles/add'}} shallow><a><i className="ti-plus"></i>&nbsp;Tambah kategori</a></Link></li>
                                    </ul>
                                </div>
                            </Col>
                        </Row>
