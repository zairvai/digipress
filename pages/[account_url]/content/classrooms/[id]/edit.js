...
class Index extends React.Component {
    ...
    pagename = ""
    links = [['App','/content/classrooms',''],['Classrooms','/content/classrooms',''],[this.item.name,`/content/classrooms/${this.item.id}`,''],["Edit",`/content/classrooms/${this.item.id}/edit`,'active']]
