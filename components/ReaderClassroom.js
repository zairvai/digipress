                ...
                <Col md={12}>
                    <div className="fright">
                        <ul className="vurox-horizontal-links vurox-standard-ul">
                            ...
                            {Permission.DELETE_CLASSROOM({auth,item}) && <li className="p-0"><Button onClick={()=>props.onDelete(item)} className="link" type="link" size="small" icon={<i className="ti-trash"></i>}>&nbsp;Hapus ruang belajar</Button></li>}
                        </ul>
                    </div>
                </Col>
            </Row>
