...
function searchManagerPut(record){
      ...
      return functions.invokeLambdaSearchManager("put",`/comment/_doc/${id}`,body)
...
function searchManagerDelete(record){
    ...
    return functions.invokeLambdaSearchManager("delete",`/comment/_doc/${id}`)
