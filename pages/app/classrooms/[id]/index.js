                            ...
                            <Row>
                                ...
                                <Col md={12}>
                                    <div className="fright">
                                        ...
                                        <li className="p-0"><Link href={{pathname:'/app/classrooms/[id]/edit',query:{id:item.id}}} shallow><Button className="link" type="link" size="small" icon={<i className="ti-pencil"></i>}>&nbsp;Edit classroom</Button></Link></li>
                                        </ul>
                                    </div>
                                </Col>
                            </Row>
                            ...
                            <Row>
                                ...
                                <Col md={12}>
                                    <div className="fright ml-3">
                                        <ul className="vurox-horizontal-links vurox-standard-ul">
                                            <li className="p-0"><Link href={{pathname:'/app/classrooms/[id]/quizes/add',query:{id:item.id}}}shallow><Button className="link" type="link" size="small" icon={<i className="ti-plus"></i>}>&nbsp;Tambah quiz</Button></Link></li>
                                        </ul>
                                    </div>
                                    <div className="fright">
                                        <ul className="vurox-horizontal-links vurox-standard-ul">
                                            <li className="p-0"><Link href={{pathname:'/app/classrooms/[id]/lessons/add',query:{id:item.id}}}shallow><Button className="link" type="link" size="small" icon={<i className="ti-plus"></i>}>&nbsp;Tambah pelajaran</Button></Link></li>
                                        </ul>
                                    </div>
                                            ...
                                            <tbody>
                                            {
                                                props.lessons.list.map(item=>(
                                                    <tr key={item.id}>
                                                        <td><Checkbox/></td>
                                                        {item.type==="lesson" ?
                                                        <td valign="middle"><Link href={{pathname:'/app/classrooms/[id]/lessons/[lid]',query:{id:item.id,lid:item.id}}} shallow><a>{item.name}</a></Link></td>
                                                        :
                                                        <td valign="middle"><Link href={{pathname:'/app/classrooms/[id]/quizes/[qid]',query:{id:item.id,qid:item.id}}} shallow><a>{item.name}</a></Link></td>
                                                        }
                                        ...
                                        <table className="table table-borderless mb-0">
                                            ...
                                            <tbody>
                                            {
                                                props.questions.list.map(item=>(
                                                    <tr key={item.id}>
                                                        <td><Checkbox/></td>
                                                        <td valign="middle"><Link href={{pathname:'/app/classrooms/[id]/questions/[qid]',query:{id:item.id,qid:item.id}}} shallow><a>{item.name}</a></Link></td>
