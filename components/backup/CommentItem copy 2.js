...
import { Row, Col,Button,Modal,Typography,Tooltip,List,Comment,Avatar } from 'antd'
...
const CommentItem = props =>{ 
    ...
    const [isReplying,setReplying] = React.useState()
                                ...
                                <>
                                    ...
                                    <div>
                                        <FormComment auth={auth} formId={`${item.id}CommentUpdate`} className="my-2" 
                                            noAvatar={true} item={item} onSuccess={onSuccessUpdate}/>
                                    </div>
                                    :
                    ...
                    <Row>
                        <Col md={24} sm={24} xs={24} className="mt-1 mb-3">
                            <FormComment auth={auth} formId={`${item.id}CommentReply`}  
                                ...
                                replyToUser={replyToUser} onSuccess={onSuccessAdd}/>
                        </Col>
                    </Row>
                }
                </>
