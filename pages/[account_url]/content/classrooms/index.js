...
class index extends React.Component {
    ...
    pagename=""
	links = [['App','/content/classrooms',''],['Classrooms','/content/classrooms','active']]
                            ...
                            <Col md={12}>
                                <div className="fright">
                                    <ul className="vurox-horizontal-links vurox-standard-ul pt-3">
										<li className="p-0"><Link href={{pathname:'/content/classrooms/add'}} shallow><a><i className="ti-plus"></i>&nbsp;Tambah classroom</a></Link></li>
										{/* <li className="p-0"><Link href={{pathname:'/content/classrooms/add'}} shallow><Button className="link" type="link" size="small" icon={<i className="ti-plus"></i>}>&nbsp;Tambah classroom</Button></Link></li> */}
                                    </ul>
                                </div>
                            </Col>
                        </Row>
											...
											<tbody>
												{
													this.props.classrooms.list.map(item=>(
														<tr key={item.id}>
															<td><Checkbox/></td>
															<td valign="middle"><Link href={{pathname:'/content/classrooms/[id]',query:{id:item.id}}} shallow><a>{item.name}</a></Link></td>
