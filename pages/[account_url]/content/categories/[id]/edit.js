...
const PageCategoryAdd = props => {
    ...
    const links = [['Content',`/${auth.account.uniqueURL}/content/classrooms`,''],['Categorys',`/${auth.account.uniqueURL}/content/categories`,''],[item.name,`/${auth.account.uniqueURL}/content/categories/${item.id}`,''],["Edit",`/${auth.account.uniqueURL}/content/categories/${item.id}/edit`,'active']]
