...
import CommentItemLevel2 from 'Components/CommentItemLevel2'

const CommentItemLevel1 = ({comment,index,...props}) => {
                ...
                {item &&
                    <Row>
                        <Col md={24} sm={24} xs={24} className="mt-1 mb-3">
                            <FormComment formId={`${item.id}CommentReply`}  post={post} replyTo={item} replyToUser={replyToUser} onSuccess={onSuccessAdd}/>
                        </Col>
                    </Row>
                }
            </span>
