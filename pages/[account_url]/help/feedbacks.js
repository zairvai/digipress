...
const PageFeedbacks = props => {

	const {auth,router} = props

	const pagename=""

	const links = [['Umum',`/${auth.account.uniqueURL}/help/feedbacks`,''],['Saran',`/${auth.account.uniqueURL}/help/feedbacks`,'active']]
...
export default connect(state=>state)(PageFeedbacks)