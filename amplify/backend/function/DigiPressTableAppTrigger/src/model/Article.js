...
function searchManagerPut(record){
      ...
      return functions.invokeLambdaSearchManager("put",`/article/_doc/${id}`,body)
...
function searchManagerDelete(record){
    ...
    return functions.invokeLambdaSearchManager("delete",`/article/_doc/${id}`)
...
function storageManagerDelete(record){
    ...
    var storageBody = {key:`public/${image.accountId.S}/articles/${id}.txt`}
